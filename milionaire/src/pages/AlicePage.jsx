...
function AlicePage() {
    ...
    const checkContractConnection = async () => {
        ...
        try {
            ...
            if (!aliceWallet) {
                setConnectionStatus('❌ Alice wallet not configured. Please set VITE_ALICE_PK and VITE_ALICE_AES_KEY in .env')
                return
            }
    ...
    const handleSubmitWealth = async () => {
        ...
        try {
            ...
            const result = await submitAliceWealth(wealth)
    ...
    const handleCompare = async () => {
        ...
        try {
            await performComparison(aliceWallet, 'Alice')
    ...
    return (
        <AppContainer>
            <CardsContainer $justifyContent="center">
                <Card $maxWidth="900px">
                    <PageTitle>Millionaires' Problem - Alice</PageTitle>
                    ...
                    <InfoBox>
                        ...
                        <InfoText style={{ marginBottom: '1rem' }}>
                            ...
                            ensuring Bob cannot see your actual wealth value.
                        </InfoText>
                        <ContractDetail>
                    ...
                    <FormGroup>
                        ...
                        <FormInput
                            type="number"
                            placeholder="Enter your wealth (e.g., 1000000)"
                            min="0"
                            value={wealth}
