...
// From deployments/production-payroll-avalancheFuji.json (2026-07-27; the underlying MTT is
// unchanged since 2026-07-17, the portal was redeployed alongside the new pMTT). Test-seed
// infra only — the UI itself never touches the portal or the public underlying, so these stay
// out of src/config/contracts.ts. The new portal runs a newer implementation
// (0xf7f7472394868e7e32bddbbd2bd66994a40f047b) that only adds withdraw(uint256); the two
// functions used below keep the same selectors and behaviour.
export const PRIVACY_PORTAL = '0x397b1DE4EbAaC2e522B583120C29ff97F011c84c' as const
